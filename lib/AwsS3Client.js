...
AwsS3Client.prototype._put = function(key, data, callback) {
...
AwsS3Client.prototype._onSuccess = function(callback, response) {
	callback(null, response.httpResponse);
};

AwsS3Client.prototype._putFile = function(key, file, callback) {
